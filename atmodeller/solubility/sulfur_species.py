...
from atmodeller.utilities import safe_log10, unit_conversion
...
class S2_sulfate_andesite_boulliung(Solubility):
    ...
    def concentration(
        ...
        logs_wtp: Array = logcs + (0.5 * safe_log10(fugacity)) + (1.5 * safe_log10(O2))
...
class S2_sulfide_andesite_boulliung(Solubility):
    ...
    def concentration(
        ...
        logs_wtp: Array = logcs - (0.5 * (safe_log10(O2) - safe_log10(fugacity)))
        s_wtp: Array = 10**logs_wtp
        ppmw: Array = s_wtp * unit_conversion.percent_to_ppm
...
class S2_sulfate_basalt_boulliung(Solubility):
    ...
    def concentration(
        ...
        logso4_wtp: Array = logcs + (0.5 * safe_log10(fugacity)) + (1.5 * safe_log10(O2))
    ...
    def concentration(
        ...
        **kwargs,
        ...
        wt_perc: Array = jnp.exp(
            ...
            + (self.coefficients[3] * safe_log10(O2))
            - 0.136
        )
