...
from atmodeller.solubility.jax_interfaces import SolubilityPowerLaw

logger: logging.Logger = logging.getLogger(__name__)


class H2_andesite_hirschmann(NamedTuple):
...
class H2_basalt_hirschmann(NamedTuple):
...
class H2O_basalt_mitchell(SolubilityPowerLaw):
    ...
    constant: float = 258.946
    exponent: float = 0.669
