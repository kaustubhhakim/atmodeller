...
#
"""JAX solubility laws for hydrogen species"""
...
H2O_ano_dio_newcombe: SolubilityProtocol = SolubilityPowerLaw(727, 0.5)
...
H2O_basalt_dixon: SolubilityProtocol = SolubilityPowerLaw(965, 0.5)
...
H2O_basalt_mitchell: SolubilityProtocol = SolubilityPowerLaw(258.946, 0.669)
...
H2O_basalt_wilson: SolubilityProtocol = SolubilityPowerLaw(215, 0.7)
...
H2O_lunar_glass_newcombe: SolubilityProtocol = SolubilityPowerLaw(683, 0.5)
...
H2O_peridotite_sossi: SolubilityProtocol = SolubilityPowerLaw(647, 0.5)
