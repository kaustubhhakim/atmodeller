...
def test_CH4(check_values: CheckValues) -> None:
    """:cite:t:`SF87{Table 1}`"""
...
def test_CO2(check_values: CheckValues) -> None:
    """:cite:t:`SF87{Table 1}`"""
...
def test_H2_SF87(check_values: CheckValues) -> None:
    """:cite:t:`SF87{Table 1}`"""
...
def test_N2(check_values: CheckValues) -> None:
    """:cite:t:`SF87{Table 1}`"""
...
def test_O2(check_values: CheckValues) -> None:
    """:cite:t:`SF87{Table 1}`"""
...
def test_H2_low_pressure_SS92(check_values: CheckValues) -> None:
...
def test_H2_medium_pressure_SS92(check_values: CheckValues) -> None:
    """:cite:t:`SS92{Figure 1}`"""
    model: RealGas = check_values.get_eos_model("H2", "shi92")
...
def test_H2_high_pressure_SS92(check_values: CheckValues) -> None:
    """:cite:t:`SS92{Figure 1}`"""
    model: RealGas = check_values.get_eos_model("H2", "shi92")
...
def test_H2_high_pressure2_SS92(check_values: CheckValues) -> None:
    """:cite:t:`SS92{Figure 1}`"""
    model: RealGas = check_values.get_eos_model("H2", "shi92")
...
def test_H2_high_pressure3_SS92(check_values: CheckValues) -> None:
    """:cite:t:`SS92{Figure 1}`"""
    model: RealGas = check_values.get_eos_model("H2", "shi92")
...
def test_H2S_low_pressure_SS92(check_values: CheckValues) -> None:
...
def test_H2S_medium_pressure_SS92(check_values: CheckValues) -> None:
    """:cite:t:`SS92{Figure 3}`"""
    model: RealGas = check_values.get_eos_model("H2S", "shi92")
...
def test_SO2_low_pressure_SS92(check_values: CheckValues) -> None:
...
def test_SO2_high_pressure_SS92(check_values: CheckValues) -> None:
    """:cite:t:`SS92{Figure 2}`"""
    model: RealGas = check_values.get_eos_model("SO2", "shi92")
...
def test_lower_extrapolation(check_values: CheckValues) -> None:
...
def test_upper_extrapolation(check_values: CheckValues) -> None:
...
def test_volume_integral_standard_pressure(check_values: CheckValues) -> None:
...
def test_volume_integral_index0(check_values: CheckValues) -> None:
...
def test_volume_integral_index1(check_values: CheckValues) -> None:
...
def test_volume_integral_index2(check_values: CheckValues) -> None:
