...
def test_Ar(check_values) -> None:
    """:cite:t:`SF87{Table 1}`"""
    model: RealGas = eos_models["Ar_cs_saxena87"]
...
def test_CH4(check_values) -> None:
    """:cite:t:`SF87{Table 1}`"""
    model: RealGas = eos_models["CH4_cs_shi92"]
...
def test_CO2(check_values) -> None:
    """:cite:t:`SF87{Table 1}`"""
    model: RealGas = eos_models["CO2_cs_shi92"]
...
def test_N2(check_values) -> None:
    """:cite:t:`SF87{Table 1}`"""
    model: RealGas = eos_models["N2_cs_saxena87"]
...
def test_O2(check_values) -> None:
    """:cite:t:`SF87{Table 1}`"""
    model: RealGas = eos_models["O2_cs_shi92"]
...
def test_H2_low_pressure_SS92(check_values) -> None:
    ...
    model: RealGas = eos_models["H2_shi92"]
...
def test_H2S_low_pressure_SS92(check_values) -> None:
    ...
    model: RealGas = eos_models["H2S_shi92"]
...
def test_SO2_low_pressure_SS92(check_values) -> None:
    ...
    model: RealGas = eos_models["SO2_shi92"]
