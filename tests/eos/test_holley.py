...
def test_H2_low(check_values: CheckValues) -> None:
...
def test_H2_high(check_values: CheckValues) -> None:
    """:cite:t:`HWZ58{Table II}`"""
    model: RealGas = check_values.get_eos_model("H2", MODEL_SUFFIX)
...
def test_H2_high_fugacity(check_values: CheckValues) -> None:
...
def test_N2_low(check_values: CheckValues) -> None:
...
def test_N2_high(check_values: CheckValues) -> None:
    """:cite:t:`HWZ58{Table III}`"""
...
def test_O2_low(check_values: CheckValues) -> None:
...
def test_O2_high(check_values: CheckValues) -> None:
    """:cite:t:`HWZ58{Table IV}`"""
    model: RealGas = check_values.get_eos_model("O2", MODEL_SUFFIX)
    pressure: float = 1000 * unit_conversion.atmosphere_to_bar
...
def test_CO2_low(check_values: CheckValues) -> None:
...
def test_CO2_high(check_values: CheckValues) -> None:
    """:cite:t:`HWZ58{Table V}`"""
    model: RealGas = check_values.get_eos_model("CO2", MODEL_SUFFIX)
    pressure: float = 1000 * unit_conversion.atmosphere_to_bar
...
def test_NH3_low(check_values: CheckValues) -> None:
...
def test_NH3_high(check_values: CheckValues) -> None:
    """:cite:t:`HWZ58{Table VI}`"""
    model: RealGas = check_values.get_eos_model("NH3", MODEL_SUFFIX)
...
def test_CH4_low(check_values: CheckValues) -> None:
...
def test_CH4_high(check_values: CheckValues) -> None:
    """:cite:t:`HWZ58{Table VII}`"""
    model: RealGas = check_values.get_eos_model("CH4", MODEL_SUFFIX)
    pressure: float = 1000 * unit_conversion.atmosphere_to_bar
...
def test_He_low(check_values: CheckValues) -> None:
...
def test_He_high(check_values: CheckValues) -> None:
    """:cite:t:`HWZ58{Table VIII}`"""
    model: RealGas = check_values.get_eos_model("He", MODEL_SUFFIX)
    pressure: float = 1000 * unit_conversion.atmosphere_to_bar
