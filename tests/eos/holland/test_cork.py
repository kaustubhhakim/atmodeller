...
eos_models_new: dict[str, RealGas] = get_eos_models()
...
def test_CO_volume_1kbar(check_values) -> None:
    ...
    model: RealGas = eos_models_new["CO_cork_cs_holland91"]
...
def test_CH4_volume_1kbar(check_values) -> None:
    ...
    model: RealGas = eos_models_new["CH4_cork_cs_holland91"]
...
def test_H2_volume_500bar(check_values) -> None:
    ...
    model: RealGas = eos_models_new["H2_cork_cs_holland91"]
...
def test_simple_CO2(check_values) -> None:
    """Simple CO2"""
    model: RealGas = eos_models_new["CO2_cork_cs_holland91"]
