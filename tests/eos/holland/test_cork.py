...
def test_CO2_volume_1kbar(check_values) -> None:
    ...
    model: RealGas = eos_models["CO2_cork_holland91"]
...
def test_CO_volume_1kbar(check_values) -> None:
    ...
    model: RealGas = eos_models["CO_cork_cs_holland91"]
...
def test_CH4_volume_1kbar(check_values) -> None:
    ...
    model: RealGas = eos_models["CH4_cork_cs_holland91"]
...
def test_H2_volume_500bar(check_values) -> None:
    ...
    model: RealGas = eos_models["H2_cork_cs_holland91"]
...
def test_simple_CO2(check_values) -> None:
    """Simple CO2"""
    model: RealGas = eos_models["CO2_cork_cs_holland91"]
...
def test_CO2_at_P0(check_values) -> None:
    ...
    model: RealGas = eos_models["CO2_cork_holland98"]
