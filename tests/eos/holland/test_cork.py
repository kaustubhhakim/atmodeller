...
def test_H2O_volume_1kbar(check_values: CheckValues) -> None:
...
def test_CO2_volume_1kbar(check_values: CheckValues) -> None:
...
def test_CO_volume_1kbar(check_values: CheckValues) -> None:
...
def test_CO_volume_2kbar(check_values: CheckValues) -> None:
    """:cite:t:`HP91{Figure 8a}`"""
    model: RealGas = check_values.get_eos_model("CO", "cork_cs_holland91")
...
def test_CO_volume_4kbar(check_values: CheckValues) -> None:
    """:cite:t:`HP91{Figure 8a}`"""
    model: RealGas = check_values.get_eos_model("CO", "cork_cs_holland91")
...
def test_CH4_volume_1kbar(check_values: CheckValues) -> None:
...
def test_CH4_volume_2kbar(check_values: CheckValues) -> None:
    """:cite:t:`HP91{Figure 8b}`"""
    model: RealGas = check_values.get_eos_model("CH4", "cork_cs_holland91")
...
def test_CH4_volume_4kbar(check_values: CheckValues) -> None:
    """:cite:t:`HP91{Figure 8b}`"""
    model: RealGas = check_values.get_eos_model("CH4", "cork_cs_holland91")
...
def test_H2_volume_500bar(check_values: CheckValues) -> None:
...
def test_H2_volume_1800bar(check_values: CheckValues) -> None:
    """:cite:t:`HP91{Figure 8c}`"""
    model: RealGas = check_values.get_eos_model("H2", "cork_cs_holland91")
...
def test_H2_volume_10kb(check_values: CheckValues) -> None:
    """:cite:t:`HP91{Figure 8c}`"""
    model: RealGas = check_values.get_eos_model("H2", "cork_cs_holland91")
...
def test_H2(check_values: CheckValues) -> None:
    """H2"""
    model: RealGas = check_values.get_eos_model("H2", "cork_cs_holland91")
...
def test_CO(check_values: CheckValues) -> None:
    """CO"""
    model: RealGas = check_values.get_eos_model("CO", "cork_cs_holland91")
...
def test_simple_CO2(check_values: CheckValues) -> None:
    """Simple CO2"""
...
def test_CO2_at_P0(check_values: CheckValues) -> None:
...
def test_CO2_above_P0(check_values: CheckValues) -> None:
...
def test_H2O_above_Tc_above_P0(check_values: CheckValues) -> None:
...
def test_H2O_below_Tc_above_P0(check_values: CheckValues) -> None:
