...
# from atmodeller.solubility.jax_carbon_species import CO2_basalt_dixon
# from atmodeller.solubility.hydrogen_species import (
#     H2_basalt_hirschmann,
#     H2O_basalt_dixon,
# )
# from atmodeller.solubility.jax_other_species import N2_basalt_libourel
# from atmodeller.solubility.jax_sulfur_species import (
#     S2_basalt_boulliung,
...
#     OS_g: Species = Species.create_gas(OS_g_data)
#     S2_g: Species = Species.create_gas(S2_g_data)
